...
run_gate() {
    ...
    case "${selected}" in
        ...
        licenses)
            ...
            if [[ "${module_path}" != "github.com/faustbrian/go-fault-injection" &&
                "${module_path}" != github.com/faustbrian/go-fault-injection/* ]]; then
            ...
            run_go_tool \
                ...
                go-licenses \
                check ./... \
                --ignore "github.com/faustbrian/go-fault-injection"
            ;;
        sbom)
            applicable security || { skip_not_applicable security; return; }
